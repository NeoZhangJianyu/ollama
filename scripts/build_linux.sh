...
if echo $PLATFORM | grep "," > /dev/null ; then
        ...
        tar c -C ./dist/linux_amd64 --exclude sycl,rocm . | pigz -9vc >./dist/ollama-linux-amd64.tgz
        ...
        tar c -C ./dist/ --exclude sycl,rocm bin lib | pigz -9vc >./dist/ollama-linux-amd64.tgz
